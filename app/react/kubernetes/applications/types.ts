...
// Revisions are have the previous application state and are used for rolling back applications to their previous state. Deployments use ReplicaSets, StatefulSets and DaemonSets use ControllerRevisions
