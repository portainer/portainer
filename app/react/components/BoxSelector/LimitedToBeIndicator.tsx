...
export function LimitedToBeIndicator({ tooltipId, url }: Props) {
  return (
    <div className="absolute left-0 top-0 w-full">
      <div className="mx-auto flex max-w-fit items-center gap-1 rounded-b-lg bg-warning-4 th-dark:bg-[color:var(--bg-BE-only)] py-1 px-3 text-sm">
        <a
        ...
        >
          <HelpCircle className="ml-1 !text-warning-7 th-dark:!text-blue-8" aria-hidden="true" />
        </TooltipWithChildren>
      </div>
    </div>
  );
