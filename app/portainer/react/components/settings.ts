...
import { SSLSettingsPanel } from '@/react/portainer/settings/SettingsView/SSLSettingsPanel/SSLSettingsPanel';
...
export const settingsModule = angular
  ...
  .component('sslSettingsPanel', r2a(withReactQuery(SSLSettingsPanel), []))
