  ...
  .controller(
    ...
    function CreateEndpointController(
      ...
      const deployCommands = {
        ...
        agentLinux: `curl -L https://downloads.portainer.io/ce${agentShortVersion}/agent-stack-ce.yml -o agent-stack.yml && docker stack deploy --compose-file=agent-stack.yml portainer-agent`,
