 ...
 * @param {ResourceControlType} resourceType Type of ResourceControl
 * @param {ResourceId} resourceId ID of involved Resource
 * @param {ResourceControlViewModel} resourceControl Previous ResourceControl (can be undefined)
 * @param {AccessControlFormData} formValues View data generated by AccessControlPanel
 */
 ...
 * @param {ResourceControlType} resourceType Type of ResourceControl
 * @param {ResourceId} resourceId ID of involved resource
 * @param {OwnershipParameters} ownershipParameters
 */
