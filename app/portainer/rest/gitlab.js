...
angular.module('portainer.app').factory('Gitlab', [
  ...
  function GitlabFactory($resource, $browser, API_ENDPOINT_REGISTRIES) {
    'use strict';
    return function (env) {
      const headers = {};
      if (env) {
      ...
      const baseUrl = `${$browser.baseHref()}${API_ENDPOINT_REGISTRIES}/:id/proxies/gitlab/api/v4/projects`;
