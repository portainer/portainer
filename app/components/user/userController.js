angular.module('user', [])
.controller('UserController', ['$q', '$scope', '$state', '$uiRouterGlobals', 'UserService', 'ModalService', 'Notifications', 'SettingsService',
function ($q, $scope, $state, $uiRouterGlobals, UserService, ModalService, Notifications, SettingsService) {
  ...
  function initView() {
    $('#loadingViewSpinner').show();
    $q.all({
      user: UserService.user($uiRouterGlobals.params.id),
