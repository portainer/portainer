angular.module('containerLogs', ['ansiToHtml', 'ngSanitize'])
.controller('ContainerLogsController', ['$scope', '$stateParams', '$anchorScroll', 'ContainerLogs', 'Container', 'ansi2html', '$sce',
function ($scope, $stateParams, $anchorScroll, ContainerLogs, Container, ansi2html, $sce) {
  $scope.state = {};
