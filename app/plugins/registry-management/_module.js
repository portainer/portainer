...
.config(['$stateRegistryProvider', function ($stateRegistryProvider) {
  ...
  var registryConfiguration = {
    ...
    views: {
      'content@': {
        templateUrl: 'app/plugins/registry-management/views/configure/configureregistry.html',
  ...
  var registryRepositories = {
    ...
    views: {
      'content@': {
        templateUrl: 'app/plugins/registry-management/views/repositories/registryRepositories.html',
  ...
  var registryRepositoryTags = {
    ...
    views: {
      'content@': {
        templateUrl: 'app/plugins/registry-management/views/repositories/edit/registryRepository.html',
