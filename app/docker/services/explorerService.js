...
angular.module('portainer.docker').factory('ExplorerService', [
  '$q',
  'Explorer',
  'EndpointProvider',
  'Upload',
  function ExplorerServiceFactory($q, Explorer, EndpointProvider, Upload) {
    'use strict';
    var service = {};
    ...
    service.upload = function (files) {
      ...
      if (files && files.length) {
        ...
        Upload.upload({
          url: 'api/endpoints/' + endpointID + '/explorer/' + self.containerId + '/upload',
          data: params,
        })
          .then(function (data) {
            deferred.resolve(data);
