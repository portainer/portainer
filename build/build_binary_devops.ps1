...
$go_path = (Get-ITEM -Path env:AGENT_HOME_DIRECTORY).Value
...
Copy-Item -Path "$go_path\api" -Destination "$go_path\api\src\github.com\portainer" -Recurse -Force -ErrorAction:SilentlyContinue
