...
func StartStackSchedules(scheduler *scheduler.Scheduler, stackdeployer StackDeployer, datastore datastore.DataStore, gitService portainer.GitService) error {
