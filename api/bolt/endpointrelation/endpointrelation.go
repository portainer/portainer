...
// Service represents a service for managing environment relation data.
type Service struct {
...
// EndpointRelation returns a Environment relation object by EndpointID
...
// UpdateEndpointRelation updates an Environment relation object
func (service *Service) UpdateEndpointRelation(EndpointID portainer.EndpointID, endpointRelation *portainer.EndpointRelation) error {
	identifier := internal.Itob(int(EndpointID))
	return internal.UpdateObject(service.connection, BucketName, identifier, endpointRelation)
}

// DeleteEndpointRelation deletes an Environment relation object
