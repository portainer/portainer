...
func initDockerClientFactory(signatureService portainer.DigitalSignatureService, reverseTunnelService portainer.ReverseTunnelService) *portainerdocker.ClientFactory {
	return portainerdocker.NewClientFactory(signatureService, reverseTunnelService)
}
...
func initSnapshotService(
	...
	dataStore dataservices.DataStore,
	dockerClientFactory *portainerdocker.ClientFactory,
