...
type UserAuthorizations map[string]bool
...
type User struct {
	...
	Authorizations UserAuthorizations `json:"Authorizations"`
}
...
const (
	OperationDockerContainerArchiveInfo         = "DockerContainerArchiveInfo"
	OperationDockerContainerList                = "DockerContainerList"
	OperationDockerContainerExport              = "DockerContainerExport "
	OperationDockerContainerChanges             = "DockerContainerChanges"
	OperationDockerContainerInspect             = "DockerContainerInspect"
	OperationDockerContainerTop                 = "DockerContainerTop"
	OperationDockerContainerLogs                = "DockerContainerLogs"
	OperationDockerContainerStats               = "DockerContainerStats"
	OperationDockerContainerAttachWebsocket     = "DockerContainerAttachWebsocket"
	OperationDockerContainerArchive             = "DockerContainerArchive"
	OperationDockerContainerCreate              = "DockerContainerCreate"
	OperationDockerContainerPrune               = "DockerContainerPrune"
	OperationDockerContainerKill                = "DockerContainerKill"
	OperationDockerContainerPause               = "DockerContainerPause"
	OperationDockerContainerUnpause             = "DockerContainerUnpause"
	OperationDockerContainerRestart             = "DockerContainerRestart"
	OperationDockerContainerStart               = "DockerContainerStart"
	OperationDockerContainerStop                = "DockerContainerStop"
	OperationDockerContainerWait                = "DockerContainerWait"
	OperationDockerContainerResize              = "DockerContainerResize"
	OperationDockerContainerAttach              = "DockerContainerAttach"
	OperationDockerContainerExec                = "DockerContainerExec"
	OperationDockerContainerRename              = "DockerContainerRename"
	OperationDockerContainerUpdate              = "DockerContainerUpdate"
	OperationDockerContainerPutContainerArchive = "DockerContainerPutContainerArchive "
	OperationDockerContainerDelete              = "DockerContainerDelete"
	OperationDockerImageList                    = "DockerImageList "
	OperationDockerImageSearch                  = "DockerImageSearch "
	OperationDockerImageGetAll                  = "DockerImageGetAll"
	OperationDockerImageGet                     = "DockerImageGet"
	OperationDockerImageHistory                 = "DockerImageHistory"
	OperationDockerImageInspect                 = "DockerImageInspect"
	OperationDockerImageLoad                    = "DockerImageLoad"
	OperationDockerImageCreate                  = "DockerImageCreate"
	OperationDockerImagePrune                   = "DockerImagePrune"
	OperationDockerImageDelete                  = "DockerImageDelete"
	OperationPortainerDockerHubInspect          = "PortainerDockerHubInspect"
	OperationPortainerDockerHubUpdate           = "PortainerDockerHubUpdate"
	OperationPortainerEndpointGroupCreate       = "PortainerEndpointGroupCreate"
	OperationPortainerEndpointGroupList         = "PortainerEndpointGroupList"
	OperationPortainerEndpointGroupDelete       = "PortainerEndpointGroupDelete"
	OperationPortainerEndpointGroupInspect      = "PortainerEndpointGroupInspect"
	OperationPortainerEndpointGroupEdit         = "PortainerEndpointGroupEdit"
	OperationPortainerEndpointGroupAccess       = "PortainerEndpointGroupAccess "
	OperationPortainerEndpointList              = "PortainerEndpointList"
	OperationPortainerEndpointCreate            = "PortainerEndpointCreate"
	OperationPortainerEndpointExtensionDelete   = "PortainerEndpointExtensionDelete"
	OperationPortainerExtensionList             = "PortainerExtensionList"
	OperationPortainerStackList                 = "PortainerStackList"
	OperationPortainerMOTD                      = "PortainerMOTD"
	OperationDockerInfo                         = "DockerInfo"
	OperationDockerVersion                      = "DockerVersion"
	OperationDockerNetworks                     = "DockerNetworks"
	OperationDockerVolumes                      = "DockerVolumes"
	OperationDockerExec                         = "DockerExec"
	OperationDockerSwarm                        = "DockerSwarm"
	OperationDockerNodes                        = "DockerNodes"
	OperationDockerServices                     = "DockerServices"
	OperationDockerSecrets                      = "DockerSecrets"
	OperationDockerConfigs                      = "DockerConfigs"
	OperationDockerTasks                        = "DockerTasks"
	OperationDockerPlugins                      = "DockerPlugins"
	OperationDockerPing                         = "DockerPing"
	OperationDockerEvents                       = "DockerEvents"
	OperationDockerSessions                     = "DockerSessions"
	OperationDockerDistributions                = "DockerDistributions"
	OperationDockerCommit                       = "DockerCommit"
	OperationDockerBuilds                       = "DockerBuilds"
	OperationDockerSystem                       = "DockerSystem"
	OperationPortainerAdmin                     = "PortainerAdmin"
)
...
func UserAuthorizationCheck(url, method string, user *User) {
	requiredAuthorization := convertURLtoOperationAuthorization(url, method)
	if user.Authorizations[requiredAuthorization] {
		fmt.Println("Authorized. GG")
	} else {
		fmt.Println("Unauthoried. RIP")
	}
}
...
func convertURLtoOperationAuthorization(url, method string) string {
	urlParts := strings.Split(url, "/")
	baseResource := urlParts[1]

	switch baseResource {
	case "containers":
		return dockerContainerOperationPermission(reqURL, method)
	case "images":
		return dockerImageOperationPermission(reqURL, method)
	case "networks":
