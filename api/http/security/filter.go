...
// FilterEndpoints filters environments based on user role and team memberships.
// Non administrator users only have access to authorized environments (can be inherited via endoint groups).
...
// FilterEndpointGroups filters environment groups based on user role and team memberships.
// Non administrator users only have access to authorized environment groups.
