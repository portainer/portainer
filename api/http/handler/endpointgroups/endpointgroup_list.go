...
// @description List all environment groups based on the current user authorizations. Will
// @description return all environment groups if using an administrator account otherwise it will
// @description only return authorized environment groups.
// @description **Access policy**: restricted
// @tags endpoint_groups
// @security jwt
// @produce json
// @success 200 {array} portainer.EndpointGroup "Environment group"
