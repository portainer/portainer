...
func (handler *Handler) buildConfig(r *http.Request, tokenData *portainer.TokenData, bearerToken string, endpoints []portainer.Endpoint) (*clientV1.Config, *httperror.HandlerError) {
	...
	for idx, endpoint := range endpoints {
		...
		configClusters[idx] = buildCluster(r, endpoint, handler.BaseURL)
...
func buildCluster(r *http.Request, endpoint portainer.Endpoint, baseURL string) clientV1.NamedCluster {
	if baseURL != "/" {
