...
type NamespaceUpdatePayload struct {
...
func (payload *NamespaceUpdatePayload) Validate(r *http.Request) error {
...
// @router /namespaces/update [put]
func (handler *Handler) namespaceUpdate(w http.ResponseWriter, r *http.Request) *httperror.HandlerError {
	var payload NamespaceUpdatePayload
