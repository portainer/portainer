...
func (handler *Handler) startStack(
	...
	case portainer.DockerComposeStack:
		...
		return handler.ComposeStackManager.Up(context.TODO(), stack, endpoint, portainer.ComposeUpOptions{ComposeOptions: portainer.ComposeOptions{Registries: filteredRegistries}})
