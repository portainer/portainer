...
// @param body body stackGitRedployPayload true "Git configs for pull and redeploy a stack. **stackName** may only be populated for Kuberenetes stacks, and if specified with a blank string, it will be set to blank"
