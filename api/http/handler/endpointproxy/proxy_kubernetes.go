...
func isKubernetesRequest(requestURL string) bool {
	return strings.HasPrefix(requestURL, "/api") || strings.HasPrefix(requestURL, "/healthz") || strings.HasPrefix(requestURL, "/version") || strings.HasPrefix(requestURL, "/openapi")
}
