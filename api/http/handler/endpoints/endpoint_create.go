...
// @description  Create a new environment that will be used to manage an environment.
// @description **Access policy**: administrator
// @tags endpoints
// @security jwt
// @accept multipart/form-data
// @produce json
// @param Name formData string true "Name that will be used to identify this environment (example: my-environment)"
...
// @param GroupID formData int false "Environment group identifier. If not specified will default to 1 (unassigned)."
// @param TLS formData bool false "Require TLS to connect against this environment"
...
// @param AzureApplicationID formData string false "Azure application ID. Required if environment type is set to 3"
// @param AzureTenantID formData string false "Azure tenant ID. Required if environment type is set to 3"
// @param AzureAuthenticationKey formData string false "Azure authentication key. Required if environment type is set to 3"
// @param TagIDs formData []int false "List of tag identifiers to which this environment is associated"
