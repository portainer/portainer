...
func configListOperation(request *http.Request, response *http.Response, executor *operationExecutor) error {
	...
	// https://docs.docker.com/engine/api/v1.28/#operation/ConfigList
...
func configInspectOperation(request *http.Request, response *http.Response, executor *operationExecutor) error {
	...
	// https://docs.docker.com/engine/api/v1.28/#operation/ConfigInspect
...
// Config object schema reference: https://docs.docker.com/engine/api/v1.28/#operation/ConfigList
