...
func displayDeprecationWarnings(flags *portainer.CLIFlags) {
	if flags.NoAnalytics != nil {
		log.Println("Warning: The --no-analytics has been depreciated and will be removed in a future version of Portainer. It has currently no effect, telemetry settings are available in the Portainer settings.")
	}
}
