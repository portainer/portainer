...
func (*Service) ParseFlags(version string) (*portainer.CLIFlags, error) {
	...
	flags := &portainer.CLIFlags{
		...
		SSLCert:                   kingpin.Flag("sslcert", "Path to the SSL certificate used to secure the Portainer instance").Default().String(),
		SSLKey:                    kingpin.Flag("sslkey", "Path to the SSL key used to secure the Portainer instance").Default().String(),
		SSLCACert:                 kingpin.Flag("sslcacert", "Path to the SSL CA certificate used to validate the edge agent cert").Default().String(),
