...
// EdgeGroupRelatedEndpoints returns a list of environments related to this Edge group
...
// edgeGroupRelatedToEndpoint returns true is edgeGroup is associated with environment
