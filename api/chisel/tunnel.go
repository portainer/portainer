...
// GetTunnelDetails returns information about the tunnel associated to an environment.
...
// SetTunnelStatusToActive update the status of the tunnel associated to the specified environment.
...
// SetTunnelStatusToIdle update the status of the tunnel associated to the specified environment.
...
// SetTunnelStatusToRequired update the status of the tunnel associated to the specified environment.
// It sets the status to REQUIRED.
// If no port is currently associated to the tunnel, it will associate a random unused port to the tunnel
// and generate temporary credentials that can be used to establish a reverse tunnel on that port.
// Credentials are encrypted using the Edge ID associated to the environment.
